...
public class CardPlayer
{
    ...
    public void dataReceived(String source, int[] data)
    {
      switch (data[0])
      {
        ...
        case Command.TALON_DATA:
          ...
          cardTable.initFirstHands(cardNumbers);
          break;
        ...
        case Command.TRUMP_SET:
    	 int size1 = data.length - 1;
         int[] cardNumbers1 = new int[size1];
         System.arraycopy(data, 1, cardNumbers1, 0, size1);
         cardTable.initLastHands(cardNumbers1);
         break;	
         
        case Command.SHOW_TRUMP:
          cardTable.setTrumpText(data[1]);
          break;
      }
    }
  ...
  private void connect(String gameRoom, String requestedName)
  {
    ...
    cardServer.tableList.add(cardTable);
